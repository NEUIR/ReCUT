...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str, 
        required=True, 
        choices=['gpqa', 'math500', 'aime','aime25','gsm8k', 'amc', 'olympiad', 'minervamath', 'livecode', 'nq', 'triviaqa', 'hotpotqa', '2wiki', 'musique', 'bamboogle', 'medmcqa', 'pubhealth'],
...
def main():
    ...
    if model_short_name in ['qwq', 'ds-llama-8b', 'ds-qwen-7b', 'ds-qwen-32b', 'sky-t1']:
        if dataset_name in ['math500', 'gpqa', 'aime', 'aime25','gsm8k', 'olympiad', 'minervamath', 'amc', 'livecode']:
        ...
        output_dir = args.output_dir+'/'+dataset_name+'.'+model_short_name
    ...
    for item in filtered_data:
        ...
        elif dataset_name in ['math500', 'aime', 'amc','aime25','gsm8k','olympiad', 'minervamath']:
            if 'qwq' in model_path.lower() or 'deepseek' in model_path.lower() or 'sky-t1' in model_path.lower():
    ...
    if max_tokens is None:
        if 'qwq' in model_path.lower() or 'deepseek' in model_path.lower() or 'sky-t1' in model_path.lower():
            if dataset_name in ['aime', 'amc','aime25','gsm8k', 'livecode','olympiad', 'minervamath']:
                max_tokens = 32768
            else:
                max_tokens = 25600
        else:
