...
def get_task_instruction_math(question, model_name=None):
    if model_name == 'qwq':
        user_prompt = (
            "Think step by step, but onlykeep a minimum draft for each thinking step, with 5 words at most.\n\n"
            "Provide your final answer in the format \\boxed{YOUR_ANSWER}.\n\n"
            f"Problem:\n{question}\n\n"
        )
    else:
...
def get_task_instruction_math(question, model_name=None):
    if model_name == 'qwq':
        user_prompt = (
            f"Please think step by step to solve this problem.\n"
            f"Problem:\n{question}\n\n"
            ...
            f"Now continue thinking from [STEP1]."
        )
    else:
        user_prompt = (
            f"Please think step by step to solve this problem.\n"
